...
if {[file exist ../PYNQ_Z1_RGB_LEDs_GEM]} {
    file delete -force ../PYNQ_Z1_RGB_LEDs_GEM
}

# создаем проект и указываем board file
create_project PYNQ_Z1_RGB_LEDs_GEM ../PYNQ_Z1_RGB_LEDs_GEM -part xc7z020clg400-1
...
# создаем hdl_wrapper
make_wrapper -files [get_files ../PYNQ_Z1_RGB_LEDs_GEM/PYNQ_Z1_RGB_LEDs_GEM.srcs/sources_1/bd/zynq_bd/zynq_bd.bd] -top
add_files -norecurse ../PYNQ_Z1_RGB_LEDs_GEM/PYNQ_Z1_RGB_LEDs_GEM.srcs/sources_1/bd/zynq_bd/hdl/zynq_bd_wrapper.v
